...
@Log4j
@WebService(serviceName = "CurrencySoapController", portName = "CurrencySoapControllerPort",
targetNamespace = "http://web.aston.org", endpointInterface = "org.aston.web.CurrencySoapController")
@RequiredArgsConstructor
public class CurrencySoapControllerImpl implements CurrencySoapController  {
    ...
    public void publishEndpoint(String url) {
        ...
        log.info("CurrencySoapController start on " + url);
    }
}
